                  ...
                  <div className="card-body">
                     <div className="email-left-box px-0 mb-3">
                        ...
                        <div className="mail-list mt-4">
                           ...
                           >
                              <i className="fa fa-inbox font-18 align-middle ms-2"></i>
                              Inbox
                           ...
                           >
                              <i className="fa fa-paper-plane font-18 align-middle ms-2"></i>
                              Sent
                           </Link>
                           <Link
                              to="/email-compose"
                              className="list-group-item"
                           >
                              <i className="fa fa-star-o font-18 align-middle ms-2"></i>
                              Important
                           ...
                           <Link
                              ...
                              className="list-group-item"
                           >
                              <i className="mdi mdi-file-document-box font-18 align-middle ms-2"></i>
                              Draft
                           </Link>
                           <Link
                              to="/email-compose"
                              className="list-group-item"
                           >
                              <i className="fa fa-trash font-18 align-middle ms-2"></i>
                              Trash
                           </Link>
                        </div>
                     ...
                     <div className="email-right-box ms-0 ms-sm-4 ms-sm-0">
                        ...
                        <div className="text-left mt-4 mb-5">
                           <button
                              className="btn btn-primary btn-sl-sm ms-2"
                              type="button"
                           >
                              <span className="ms-2">
