                    ...
                    <div className="col-xl-3 col-lg-4">
                      <div className="">
                        ...
                        <div className="mail-list rounded overflow-hidden mt-4">
                            <div className="intro-title category-style d-flex justify-content-between my-0">
                              <h5>Categories</h5>
                              <i className="fa fa-chevron-down"></i>
                            </div>
                            <Link to={"/email-inbox"} className="list-group-item"><span className="icon-warning"><i className="fa fa-circle"></i></span>
                              Work </Link>
                            <Link to={"/email-inbox"} className="list-group-item"><span className="icon-primary"><i className="fa fa-circle"></i></span>
                              Private </Link>
                            <Link to={"/email-inbox"} className="list-group-item"><span className="icon-success"><i className="fa fa-circle"></i></span>
                              Support </Link>
                            <Link to={"/email-inbox"} className="list-group-item"><span className="icon-dpink"><i className="fa fa-circle"></i></span>
                              Social </Link>
                        </div>
                      </div>
                    </div>
