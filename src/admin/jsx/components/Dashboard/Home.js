    ...
    <>
      <div className="form-head d-flex mb-3 align-items-start">
        ...
        <Dropdown className="dropdown custom-dropdown">
          <Dropdown.Toggle
            className="btn btn-sm btn-primary light d-flex align-items-center svg-btn i-false"
          ...
          >
            ...
            <div className="text-start ms-3">
              ...
              <small className="d-block fs-13">4 June 2023 - 4 July 2023</small>
            </div>
      ...
      <div className="row">
              ...
              <div className="media ai-icon">
                ...
                <div className="media-body">
                  <h3 className="mb-0 text-black">
                    {/* <span className="counter ms-0"> */}
                      <CountUp className="ms-0" start={0} end={56} duration={5} />
                    {/* </span> */}
                  </h3>
              ...
              <div className="media ai-icon">
                ...
                <div className="media-body">
                  <h3 className="mb-0 text-black">
                    {/* <span className="counter ms-0"> */}
                      {" "}
                      <CountUp className="ms-0" start={0} end={12} duration={5} />
                    {/* </span> */}
                    k
                  </h3>
            ...
            <div className="card-body p-4">
              <div className="media ai-icon">
                ...
                <div className="media-body">
                    <h3 className="mb-0 text-black">
                      {" "}
                      <CountUp className="ms-0" start={0} end={20} duration={5} />
                    </h3>
              ...
              <div className="media ai-icon">
                ...
                <div className="media-body">
                  <h3 className="mb-0 text-black">
                    {/* <span className="counter ms-0"> */}
                      {" "}
                      <CountUp className="ms-0" start={0} end={65} duration={5} />
                    {/* </span> */}
                  </h3>
              ...
              <div className="card-body orders-summary">
                <Tab.Content>
                  ...
                  <div className="d-flex order-manage p-3 align-items-center mb-4">
                    <Link
                      to="#"
                      className="btn fs-22 py-1 btn-success px-4 me-3"
                    >
                      25
                    </Link>
                    <h4 className="mb-0">
                      New Orders{" "}
                      <i className="fa fa-circle text-success ms-1 fs-15" />
                    </h4>
                    <Link to="#" className="ms-auto text-primary font-w500">
                      Manage orders <i className="ti-angle-right ms-1" />
                    </Link>
                  </div>
                  <div className="row">
                    ...
                    <div className="row align-items-center">
                      ...
                      <div className="col-xl-9 col-lg-10 col-xxl-8 col-sm-9 col-md-9">
                        <div className="d-flex align-items-center mb-3">
                          <p className="mb-0 fs-14 me-2 col-4 col-xxl-5 px-0">
                            Immunities (24%)
                          </p>
                          <div
                          ...
                          <span className="pull-right ms-auto col-1 col-xxl-2 px-0 text-end">
                            25
                          </span>
                        </div>
                        <div className="d-flex align-items-center  mb-3">
        ...
        <div className="col-xl-3 col-xxl-3 col-lg-4 col-md-12">
          <div
            ...
            style={{backgroundImage:"url(" + bgicon+ ")",backgroundRepeat: "no-repeat", backgroundPosition: "top right",}}
          >
