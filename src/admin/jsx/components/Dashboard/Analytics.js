    ...
    <>
      <div className="form-head d-flex mb-3 align-items-start">
        <div className="me-auto d-none d-lg-block">
          <h2 className="text-primary font-w600 mb-0">Analytics</h2>
          <p className="mb-0">
                  ...
                  <div className="d-flex align-items-end ps-3">
                    <div className="me-4">
                      <h3 className="font-w600 mb-0">
                        ...
                        {/* <span className="counter"> */}
                          <CountUp className="counter" start={0} end={257} duration={5} />
                        {/* </span> */}
                        k
                      </h3>
                    ...
                    <div>
                      <h3 className="font-w600 mb-0">
                        ...
                        />
                        {/* <span className="counter"> */}
                          <CountUp className="counter" start={0} end={1245} duration={5} />
                        {/* </span> */}
              ...
              <div className="card">
                ...
                <div className="card-body p-0 pt-3">
                  <div className="media items-list-1">
                    ...
                    <div className="media-footer ms-auto col-3 px-0 d-flex align-self-center align-items-center">
                      <div className="me-3">
                       
                        <Sparklines  data={[0,2,1,4]}
                          style={{             
                            strokeWidth: 3,               
                            height:"30px",
                            width:"50px",
                  ...
                  <div className="card-body tab-content">
                    <Tab.Content>
                        ...
                        <div className="media mb-4 items-list-2">
                          ...
                          <div className="media-body col-6 px-0">
                            ...
                            <ul className="fs-14 list-inline">
                              <li className="me-3">Serves for 4 Person</li>
                              <li>24mins</li>
                            </ul>
                          </div>
                      ...
                      <div className="card-footer border-0 pt-0 text-center mt-4">
                        <Link to="#" className="btn-link">
                          View more
                          <i className="fa fa-angle-down ms-2 scale-2" />
                        </Link>
                      </div>
                    </Tab.Content>
                  </div>
